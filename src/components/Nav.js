...
const Nav = () => {
  return (
    <div className="w-full container mx-auto p-6 h-1/6">
      <div className="w-full flex items-center justify-between">
        <Link href="/" className='flex items-center text-blue-900 no-underline hover:no-underline font-bold text-3xl lg:text-4xl leading-4'>
          <Image src="/logo.png" alt="Logo" width={60} height={60} className='mr-3' /> MindVerse
        </Link>
